...
public class TANTemperature {
	...
	private static void registerBlockTemperatureSources() {
		TemperatureRegistry.registerTemperatureSource("B", Item.getIdFromItem(Item.getItemFromBlock(Blocks.FIRE)), -1,
				4F, 0.08F);
	...
	private static void registerArmourTemperatureSources() {
		...
		// Leather
		TemperatureRegistry.registerTemperatureSource("A", Item.getIdFromItem(Items.LEATHER_HELMET), 0, 0.75F, 0.1F);
		TemperatureRegistry.registerTemperatureSource("A", Item.getIdFromItem(Items.LEATHER_CHESTPLATE), 0, 1F, 0.2F);
		TemperatureRegistry.registerTemperatureSource("A", Item.getIdFromItem(Items.LEATHER_LEGGINGS), 0, 0.5F, 0.15F);
		TemperatureRegistry.registerTemperatureSource("A", Item.getIdFromItem(Items.LEATHER_BOOTS), 0, 0.25F, 0.25F);

		// Gold
		TemperatureRegistry.registerTemperatureSource("A", Item.getIdFromItem(Items.GOLDEN_HELMET), 0, 0.25F, 0.01F);
		TemperatureRegistry.registerTemperatureSource("A", Item.getIdFromItem(Items.GOLDEN_CHESTPLATE), 0, 0.5F, 0.1F);
